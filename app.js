...
Vue.component('faq', {
	props: ['question', 'index', 'open'],
	template: `
	<div :class="[ open ? 'questions-on': 'questions-off']" @click="$emit('chosen_question', index)">
	 <span class="title"><h1 class="question">{{question.question}}</h1></span>
	  <h3 class="answer" v-html="space(question.answer)"></h3>
	</div>
	`,
